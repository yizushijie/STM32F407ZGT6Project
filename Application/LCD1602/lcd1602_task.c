...
{
	return LCD1602Lib_WriteCmd(cmd);
}
...
{
	return LCD1602Lib_WriteData(val);
}
...
{
	return LCD1602Lib_SetCursor(xPos, yPos);
}
...
{
	return LCD1602Lib_ShowChar(xPos, yPos, dat);
}
///////////////////////////////////////////////////////////////////////////////
//////函	   数：
//////功	   能：LCD1602初始化
...
{
	return LCD1602Lib_ShowStr(xPos, yPos, str);
}